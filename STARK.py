...
f"""{Hj}
 ...
 - instagram   : savage_fundz2
 - facebook    : facebook.com/okenwa.bright24
 - whatsap     : +2347061758885
 - github      : github.com/Savagefundzokenwa
 - script name : MD
 - version     : 1.0
 - update pada : 21 March 2022
...
author = 'Okenwa'
fb_me = 'facebook.com/okenwa.bright24'
github = 'github.com/Savagefundzokenwa'
...
def uas(_romz_):
	if _romz_ == '':
		...
		if ua in(""):
			...
			ua_ = ("Mozilla/5.0 (Linux; Android 12; SM-G977B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.101 Mobile Safari/537.36")
